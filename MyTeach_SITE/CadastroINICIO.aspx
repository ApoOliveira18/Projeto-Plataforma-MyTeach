<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CadastroINICIO.aspx.cs" Inherits="CadastroINICIO" %>
...
<section id="section-about" class="section appear clearfix">
    <div class="container">
      ...
      <div class="row mar-bot40">
        <div class="col-md-offset-3 col-md-6">
          <div class="section-header">
            <h2 class="section-heading animated" data-animation="bounceInUp">Cadastro de Usúarios</h2>
            <p>Escolha um tipo de usúario</p>
          </div>
        </div>
      </div>
      ...
      <div class="row mar-bot40">
            ...
            <div class="auto-style2 col-md-offset-2 col-md-3" style="font-size: 16px; color: #000000;">
               Selecione o tipo de cadastro:
            </div>

            <div class="col-md-2">
               <asp:RadioButtonList ID="rbnTipoUso" runat="server" CssClass="auto-style2">
            ...
            <div class="col-md-4">
               <asp:CheckBox ID="chkTermo" runat="server" /> Você concorda com os <asp:LinkButton ID="LinkButton1" runat="server" class="cadastro" ForeColor="#3366FF" OnClick="LbkAluno_Click" >Termos de Usúario</asp:LinkButton>
            <br />
      ...
      <div class="row mar-bot40">
            <div class="col-md-offset-4 col-md-3">
               <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="rbnTipoUso" ErrorMessage="Selecione o tipo para cadastro!" ForeColor="Red"></asp:RequiredFieldValidator>
            </div>
      </div>
      ...
      <div class="row mar-bot40">
            ...
            <div class="col-md-offset-2 col-md-2" style="float:left;">
               <asp:Button runat="server" BackColor="#00C9BC" Text="VOLTAR" OnClick="btnVoltarSel_Click" />
            </div>
            
            <div class="col-md-4"></div> 

            <div class="col-md-2">
               <asp:Button runat="server" Text="CARREGAR" OnClick="btnSelecionar_Click" BackColor="#00C9BC"/>
            </div>
      ...
      <div class="row mar-bot40">
          <div class="col-md-offset-2 col-md-9">
              <object data="img/Anuncios/AnuncioNanda3.swf" class="img-responsive" style="margin-top:20px; height:180px; width:770px;" id="ANUNCIO2">

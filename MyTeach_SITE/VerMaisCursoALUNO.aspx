<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VerMaisCursoALUNO.aspx.cs" Inherits="VerMaisCursoALUNO" %>
...
<head>
  ...
  <link rel="stylesheet" href="css/style2VerMaisInfo.css">
  <!-- skin -->
      ...
      <div class="row mar-bot40">
        <div class="col-md-6">
          <div class="section-header">
			...
			<h3 style="float: left;">Valor:  <asp:Label ID="lblValor" runat="server"></asp:Label> </h3>
             <br />
              <asp:Button ID="btnComprar" runat="server" Text="Comprar" style="float:right; background-color:#80ed2d; width: 89px; height: 39px; text-align:center;" class="btnDownload btn btn-theme" OnClick="btnComprar_Click" />
          </div>
        </div>
        ...
        <div class="col-md-6" style="margin-top:55px;">
            ...
            <div style="margin-top:10px"><span class="auto-style1">Professor: </span>
                <asp:LinkButton ID="lnbProf" runat="server" ForeColor="#00c9bc" OnClick="lnbProf_Click"></asp:LinkButton>
            </div>
         ...
         <div style="margin-top:10px"><span class="auto-style1">Contem: </span><asp:Label ID="lblContem" runat="server" Text="" style="width:300px;"></asp:Label>
             <br />
             <br />
